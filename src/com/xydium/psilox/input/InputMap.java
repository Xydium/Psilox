...
public class InputMap 
{
	...
	public InputMap(Input input) {
		this.inputMap = new HashMap<String, ArrayList<Integer>>();
		this.input = input;
	}
	
	public InputMap(Input input, String mapPath) {
		this(input);
		loadMap(mapPath);
	}
	...
	private void loadMap(String mapPath) {
		...
		} catch(Exception e) { Log.error("No such input map: " + mapPath); Log.error(e); }
	}
